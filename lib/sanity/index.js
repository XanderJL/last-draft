  ...
  types: {
    block: (props) => {
      ...
      switch (style) {
        case "h1":
          return (
            <Heading size="xl" textTransform="uppercase" pb="0.5rem">
              {props.children}
            </Heading>
          )
        case "h2":
          return (
            <Heading as="h2" size="lg" textTransform="uppercase" pb="0.5rem">
              {props.children}
            </Heading>
          )
        case "h3":
          return (
            <Heading as="h3" size="md" textTransform="uppercase" pb="0.5rem">
              {props.children}
            </Heading>
          )
        case "blockquote":
